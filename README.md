...
1. Открой раздел **[Releases](../../releases)** этого репозитория (⚠️ не зелёную кнопку «Code → Download ZIP» — там исходники).
2. Скачай **`Nous-x.y.z-portable.zip`**, распакуй и запусти `Nous.exe` — установка не нужна, можно держать хоть на рабочем столе.
3. На первом экране вставь свой ключ Groq.
...
> Если предпочитаешь обычную установку с ярлыком — в релизе есть и установщик `Nous_x.y.z_x64-setup.exe`.
