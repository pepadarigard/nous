    ...
    return (
      <div className="fade-in">
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <p className="small muted" style={{ marginBottom: 0 }}>
            Не доверяешь себе — сфотографируй лист во вкладке{' '}
            <a href="#/trainer?tab=check">«Развёрнутый ответ»</a>: ИИ прочитает рукописное решение
            и разложит баллы по критериям.
          </p>
        </div>
