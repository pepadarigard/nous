        ...
        <div className="toggle-row">
          <div>
            ...
            <div className="small muted" style={{ marginTop: 3 }}>
              Показывать на «Прогрессе» примерный балл по каждому предмету. Считается по РЕШЁННОМУ
              в тренажёре: точность по каждому номеру умножается на его вес в первичных баллах, и
              сумма переводится по официальной шкале. Отметки в плане на балл не влияют. Рядом всегда
              видно, какая доля работы вообще проверена, — это ориентир, а не гарантия ЕГЭ.
            </div>
          </div>
          <button
